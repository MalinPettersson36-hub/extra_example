...
export class InsurancePage {
    ...
    async fillInsuranceForm(firstName:string, lastName: string, address: string, apartmentSize: string, adults: string, kids:string){
...
*/
 /*   async calculatePrice() {
    ...
    async verifyPrices(expectedMonthly: string, expectedYearly: string) {
        await expect(this.monthlyPrice).toContainText(expectedMonthly);
